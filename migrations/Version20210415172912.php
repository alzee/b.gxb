 ...
 */
final class Version20210415172912 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE task ADD status_id INT DEFAULT NULL, DROP status');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE task ADD status SMALLINT DEFAULT NULL, DROP status_id');
    }
}
