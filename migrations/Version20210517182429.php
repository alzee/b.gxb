...
final class Version20210517182429 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('INSERT INTO `land` VALUES (1,NULL,NULL,\'主城\',5000,1,NULL,\'2021-05-28 05:13:38\')');
        $this->addSql('ALTER TABLE user AUTO_INCREMENT = 100');
        $this->addSql('ALTER TABLE node AUTO_INCREMENT = 100');
    }
